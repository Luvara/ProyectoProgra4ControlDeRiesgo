...
import Modal from "../../modal"; // Asegúrate de importar el modal correctamente
import Pagination from "../../form/pagination"; // Asegúrate de importar correctamente tu componente de paginación
