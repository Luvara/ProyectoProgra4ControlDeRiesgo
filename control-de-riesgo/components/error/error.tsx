...
const Error_page = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen py-2">
      <Image src="/error.svg" width={300} height={300} alt="Image"></Image>
      <div className="my-4 flex flex-col items-center md:justify-between text-white bg-background-3 shadow-lg rounded-lg p-5">
        <h1 className="text-[4rem]">Error</h1>
        <p className="text-[3rem]">{error ? error : "Somthing is wrong!!"}</p>
        <p className="text-[3rem]">Please contact administration!</p>
